...
public class Main {
    public static void main(String[] args) {
        ...
        String min,max;
        k=numbers.length;
        System.out.println("Кол членов ряда = " + k);
   // определяем минимум
        n1=1000;
        for (i = 0; i < k; i++) {
...
//Печать массива без повторов
        ...
        int pov1=0; int pov2=0;   int irab=0;
//
        for (i = 0; i < k; i++) {
           if (numbers[i] != n1 & numbers[i] != n2) {System.out.println(numbers[i]); rab[irab]=numbers[i]; irab=irab+1;}
//
            if (numbers[i] == n1 & pov1==0) {System.out.println(numbers[i]); pov1=1; rab[irab]=numbers[i]; irab=irab+1;}
            if (numbers[i] == n2 & pov2==0) {System.out.println(numbers[i]); pov2=1; rab[irab]=numbers[i]; irab=irab+1;}
        }
        System.out.println(" irab="+ irab);
        int [] rab1 = new int[irab];
        for (i = 0; i < irab; i++) {
        rab1[i]=rab[i];
        }
//====================================
